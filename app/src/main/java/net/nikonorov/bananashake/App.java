...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        cities.add(new City(1, "Australia", "Canberra", "canberra", "saber/saber.g3db"));

        cities.add(new City(2, "New Zealand", "Wellington", "wellington", "saber/saber.g3db"));
        cities.add(new City(3, "New Zealand", "Auckland", "auckland", "saber/saber.g3db"));

        cities.add(new City(4, "China", "Beijing", "beijing", "saber/saber.g3db"));
        cities.add(new City(5, "China", "Shanghai", "shanghai", "saber/saber.g3db"));

        cities.add(new City(6, "Japan", "Tokyo", "tokyo", "saber/saber.g3db"));
        cities.add(new City(7, "Japan", "Yokohama", "yokohama", "saber/saber.g3db"));
        ...
        cities.add(new City(13, "Egypt", "Hurghada", "hurghada", "saber/saber.g3db"));

        cities.add(new City(14, "Marocco", "Rabat", "rabat", "saber/saber.g3db"));
        cities.add(new City(15, "Marocco", "Casablanca", "casablanca", "saber/saber.g3db"));
