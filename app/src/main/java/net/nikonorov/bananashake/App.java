...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        cities.add(new City(1, "Australia", "Sidney", "sidney", "saber/saber.g3db", 2, 9));

        cities.add(new City(2, "New Zealand", "Wellington", "wellington", "saber/saber.g3db", 3, 13));
        cities.add(new City(3, "New Zealand", "Wellington", "wellington", "saber/saber.g3db", 2, 10));

        cities.add(new City(4, "China", "Beijing", "beijing", "saber/saber.g3db", 1, 4));
        cities.add(new City(5, "China", "Beijing", "beijing", "saber/saber.g3db", 2, 8));

        cities.add(new City(6, "Japan", "Tokyo", "tokyo", "saber/saber.g3db", 2, 10));
        cities.add(new City(7, "Japan", "Tokyo", "tokyo", "saber/saber.g3db", 3, 14));
        ...
        cities.add(new City(13, "Egypt", "Cairo", "cairo", "saber/saber.g3db", 2, 9));

        cities.add(new City(14, "Marocco", "Rabat", "rabat", "saber/saber.g3db", 3, 13));
        cities.add(new City(15, "Marocco", "Rabat", "rabat", "saber/saber.g3db", 2, 7));
